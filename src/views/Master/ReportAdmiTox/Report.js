...
import { AdmeToxBuilder_Delete, AdmeToxBuilder_GetAll, AdmeToxBuilder_UpdateSequence, BE_OrganizationUser_UpdateTooltipSteps } from '../../../common/allApiEndPoints';


class ListAdmi extends Component {
  constructor(props) {
    super(props);
    ...
    this.initialState = {
      ...
      steps: [{
        element: "#pagetitle",
        title: 'ADME-Tox Builder',
        intro: "Used to add or update sections in the ADME-Tox Report.",
  ...
  getListData(pageNo) {
    ...
    const apiroute = window.$APIPath;
    // const url = apiroute + '/api/AdmeToxBuilder/GetAll';
    const url = apiroute + AdmeToxBuilder_GetAll
  ...
  deleteRow(e, id) {
    ...
    this.setState({ loading: true });
    const apiroute = window.$APIPath;
    // const url = apiroute + '/api/AdmeToxBuilder/Delete?id=' + id + '&userId=' + userId + '';
    const url = apiroute + AdmeToxBuilder_Delete(id, userId)
  ...
  handleDragEnd = (e) => {
    ...
    if (this.state.diseases) {
      ...
      // console.log(data);
      // let url = apiroute + '/api/AdmeToxBuilder/UpdateSequence';
      let url = apiroute + AdmeToxBuilder_UpdateSequence;
      ...
      <div className="animated fadeIn">
        ...
        <Row className="mb-3">
          ...
          <Col xs="1" lg="1">
            {
              this.state.isEdit ? <>
                <Link to="/master/Admereport/AdmeDetails">
                                      ...
                                      <td>
                                        <div className='d-flex'>
                                          <Link
                                            ...
                                            to={`/master/Admereport/modify/${data.admeToxBuilderId}`}>Edit</Link>{" "}
                                                ...
                                                ? <Confirm
                                                  ...
                                                  {confirm => (
                                                    <Link
                                                      ...
                                                      to="#"
                                                      onClick={confirm(e => this.deleteRow(e, data.admeToxBuilderId))}>
                                                      <b>Inactive</b>
                                                    </Link>
                                                  )}
                                                </Confirm>
