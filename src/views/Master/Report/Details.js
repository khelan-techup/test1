...
import { BE_DiseaseCategory_GetAll, BE_ReportBuilder_DeleteReportBuilderImage, BE_ReportBuilder_GetById, BE_ReportBuilder_Save, BE_ReportBuilder_Update, BE_ReportBuilder_UploadReportBuilderImage, BE_ReportBuilder_UploadRportBuilderCkeditorImage } from '../../../common/allApiEndPoints';
...
class Details extends Component {
  ...
  componentDidMount() {
    ...
    axiosInstance.post(url, data, {
      ...
      .then(result => {
        if (result.data.flag) {
          //   let dcat = result.data.outdata.filter(category => category.diseaseCategoryName.toLowerCase() != 'healthindex');
          ...
          // .filter(category => category.diseaseCategoryName.toLowerCase() == 'With ctDNA & cfDNA testing'.toLowerCase() || category.diseaseCategoryName.toLowerCase() == 'cancer' || category.diseaseCategoryName.toLowerCase() == 'complete health score' || category.diseaseCategoryName.toLowerCase() == 'No ctDNA & cfDNA testing'.toLowerCase() || category.diseaseCategoryName.toLowerCase() == 'Cancer - No Tumor'.toLowerCase() || category.diseaseCategoryName.toLowerCase() == 'Prevention'.toLowerCase());
  ...
  getData = (id) => {
    const apiroute = window.$APIPath;
    // const url = apiroute + '/api/BE_ReportBuilder/GetById?id=' + id + '';
    const url = apiroute + BE_ReportBuilder_GetById(id)
      ...
      .then(result => {
        if (result.data.flag) {
          ...
          this.setState({
            title: rData.title,
            title2: rData.title,
            reportBuilderId: rData.reportBuilderId,
            reportBuilderId2: rData.reportBuilderId,
  ...
  handleSubmit(e) {
    ...
    if (this.validateForm(this.state.errors)) {
      ...
      if (this.state.reportBuilderId == 0) {
        // url = apiroute + '/api/BE_ReportBuilder/Save';
        url = apiroute + BE_ReportBuilder_Save
      }
      else {
        // url = apiroute + '/api/BE_ReportBuilder/Update';
        url = apiroute + BE_ReportBuilder_Update
      }
      ...
      let data = JSON.stringify({
        reportBuilderId: this.state.reportBuilderId,
      ...
      axiosInstance.post(url, data, {
        ...
        .then(result => {
          ...
          if (result.data.flag) {
            ...
            this.props.history.push('/master/report/list');
          }
          else {
  ...
  handleAddImage(e) {
    ...
    if (imgTag != undefined && imgTag != "" && imgfile != undefined && imgfile != "" && index === -1) {
      ...
      let rurl = apiroute + BE_ReportBuilder_UploadReportBuilderImage
      let files = imgfile;
  ...
  deleteImage(e, id, index) {
    ...
    if (id == 0) {
      ...
      const url = apiroute + BE_ReportBuilder_DeleteReportBuilderImage(id, userId)
                  ...
                  <Row>
                    ...
                    <Col xs="12">
                      ...
                      <FormGroup>
                        ...
                        <svg id="Summary Title" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-info-circle mx-2" viewBox="0 0 16 16">
                          <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                          <path d="m8.93 6.588-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533L8.93 6.588zM9 4.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0z" />
                        </svg>
                        {/* <span className='ml-2 h5' > <i className="fa fa-info-circle" aria-hidden="true"></i></span> */}
