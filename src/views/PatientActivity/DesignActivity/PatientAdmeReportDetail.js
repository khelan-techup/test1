...
class PatientAdmeReportDetail extends Component {
  ...
  render() {
    ...
    const { loading, PatientId,
      ...
      showGenetic, geneticDesc, geneticTitle
    } = this.state;
        ...
        <Row className="mb-3">
          ...
          <Col xs="2" lg="2">
            <Link to={this?.props?.location?.state?.redirectTo ? this?.props?.location?.state?.redirectTo : '/patientactivity/designactivity'}>
              {this?.props?.location?.state?.redirectTo ? <button className="btn btn-primary btn-block">Back to Details</button> : <button className="btn btn-primary btn-block">List</button>}
            </Link>
          </Col>
        </Row>
        <Row>
...
export default PatientAdmeReportDetail;
