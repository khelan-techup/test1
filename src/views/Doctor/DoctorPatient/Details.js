...
import { BE_Patient_GetById } from '../../../common/allApiEndPoints';
...
class Details extends Component {
  ...
  handleModalClose = () => {
    ...
    if (this.state.redirect) {
      this.props.history.push('/practitioners/patients');
    }
  }
  ...
  getData = (id) => {
    ...
    const url = apiroute + BE_Patient_GetById(id)
                        ...
                        <Table responsive bordered key="tblPInsurance">
                          ...
                          <tbody>
                            {insuranceDetail.length > 0 ? (
                              ...
                              <tr>
                                <td colSpan="4" className="tdCenter">No insurance detail found.</td></tr>
                            )
                            }
                          </tbody>
                        </Table>
