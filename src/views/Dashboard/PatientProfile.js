...
import { BE_Patient_GetProfile } from "../../common/allApiEndPoints";
...
class PatientProfile extends Component {
  ...
  getData = (id, aid) => {
    ...
    const url =
      ...
      apiroute + BE_Patient_GetProfile + "?id=" + id + "&aid=" + aid + "";
    ...
    return (
      <div className="animated fadeIn">
        ...
        <Row className="mb-3">
          <Col xs="10" lg="10">
            <h5 className="mt-2">
              <i className="fa fa-align-justify"></i> Patient Details{" "}
              {patientaccessionmapping != ""
                ? "(" +
                  ...
                  <CardBody>
                    ...
                    <FormGroup row>
                      ...
                      <Col md="4">
                        ...
                        <Col xs="12" md="9">
                          <span className="form-control">
                            {basicInfo.mobile != null ? basicInfo.mobile : ""}
                          </span>
                        </Col>
                      </Col>
                      <Col md="4">
                ...
                <CardBody>
                  <Row>
                    <Col xs="6">
                      <FormGroup>
                        ...
                        {patientaccessionmapping.diseaseName != "" &&
                          patientaccessionmapping.diseaseName != null ? (
                          <span>
                            {patientaccessionmapping.diseaseName +
                              " (" +
                              patientaccessionmapping.diseaseCode +
                              ")"}
                          </span>
                        ) : (
                          "Not Assigned"
                    ...
                    <Col xs="6">
                      <FormGroup>
                        ...
                        {patientaccessionmapping.tissue != "" &&
                          patientaccessionmapping.tissue != null ? (
                          <span>{patientaccessionmapping.tissue}</span>
                        ) : (
                          "Not Assigned"
                        )}
                      </FormGroup>
                  ...
                  <Row>
                    ...
                    {assignedinstitute != "" && assignedinstitute != null ? (
                      ...
                      <Col xs="12">
                        <FormGroup>Not Assigned</FormGroup>
                      </Col>
                    )}
                  </Row>
                  <hr />
                              ...
                              prescription.map((data, i) => {
                                return (
                                  <React.Fragment>
                                    ...
                                    >
                                      <td colSpan="3">
                                        {data?.patientPrescriptionFile?.length >
                                          0
